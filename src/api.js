...
export const fetchQuotationById = () => api.get(`/quotations/quotationitems`);
...
export const sendQuotationEmail = async (quotationId, recipientEmail) => {
  const response = await fetch(`/quotations/${quotationId}/send-email`, {
    method: 'POST',
    headers: {
